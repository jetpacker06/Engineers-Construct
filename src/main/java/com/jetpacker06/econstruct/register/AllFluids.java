...
public class AllFluids {
    ...
    static {
        ...
        MOLTEN_ANDESITE_LIQUID_BLOCK = AllBlocks.BLOCKS.register("molten_andesite", () -> new LiquidBlock(AllFluids.MOLTEN_ANDESITE, BlockBehaviour.Properties.of(Material.WATER).noCollission().strength(100f).noDrops()));
        ...
        MOLTEN_REDSTONE_LIQUID_BLOCK = AllBlocks.BLOCKS.register("molten_redstone", () -> new LiquidBlock(AllFluids.MOLTEN_REDSTONE, BlockBehaviour.Properties.of(Material.WATER).noCollission().strength(100f).noDrops()));
        ...
        MOLTEN_ROSE_QUARTZ_LIQUID_BLOCK = AllBlocks.BLOCKS.register("molten_rose_quartz", () -> new LiquidBlock(AllFluids.MOLTEN_ROSE_QUARTZ, BlockBehaviour.Properties.of(Material.WATER).noCollission().strength(100f).noDrops()));
    }
